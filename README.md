...
<tspan x="370" y="30">Abror@Alisherov</tspan>
<tspan x="370" y="50">——————</tspan>
<tspan x="370" y="70" class="keyColor">OS</tspan>: <tspan class="valueColor">Arch Linux x86_64</tspan>
<tspan x="370" y="90" class="keyColor">Uptime</tspan>: <tspan class="valueColor">17 years, 8 months, 16 days</tspan>
<tspan x="370" y="110" class="keyColor">Host</tspan>: <tspan class="valueColor">Tashkent, Chirchiq, Uzbekistan</tspan><tspan class="commentColor"/>
<tspan x="370" y="130" class="keyColor">Kernel</tspan>: <tspan class="valueColor">Software Engineer</tspan><tspan class="commentColor"/>
<tspan x="370" y="150" class="keyColor">IDE</tspan>: <tspan class="valueColor">Neovim v0.7.0, VSCode 1.64.0</tspan>
<tspan x="370" y="190" class="keyColor">Languages</tspan>.<tspan class="keyColor">Programming</tspan>: <tspan class="valueColor">JavaScript, TypeScript</tspan>
<tspan x="370" y="210" class="keyColor">Languages</tspan>.<tspan class="keyColor">Computer</tspan>: <tspan class="valueColor">HTML, CSS, JSON, YAML, Markdown</tspan>
<tspan x="370" y="230" class="keyColor">Languages</tspan>.<tspan class="keyColor">Real</tspan>: <tspan class="valueColor">Uzbek,English</tspan>
<tspan x="370" y="270" class="keyColor">Hobbies</tspan>.<tspan class="keyColor">Software</tspan>: <tspan class="valueColor">WM costomization, Linux Distribution</tspan>
...
<tspan x="370" y="370" class="keyColor">Email</tspan>: <tspan class="valueColor">abroralisherov90@gmail.com</tspan>
<tspan x="370" y="390" class="keyColor">Telegram</tspan>: <tspan class="valueColor">@AbrorAlisherov</tspan>
<tspan x="370" y="410" class="keyColor">LinkedIn</tspan>: <tspan class="valueColor">AbrorAlisherov</tspan>
<tspan x="370" y="450" class="keyColor">GitHub Stats</tspan>:
<tspan x="370" y="470">——————</tspan>
<tspan x="370" y="490" class="keyColor">Repos</tspan>: <tspan class="valueColor">26</tspan> {<tspan class="keyColor">Contrib_to</tspan>: <tspan class="valueColor">29</tspan>} | <tspan class="keyColor">Commmits</tspan>: <tspan class="valueColor">420    </tspan> | <tspan class="keyColor">Stars</tspan>: <tspan class="valueColor">18</tspan>
<tspan x="370" y="510" class="keyColor">Lines of Code Written by Me</tspan>: <tspan class="valueColor">78,230</tspan> (<tspan class="addColor">88,153++</tspan>, <tspan class="delColor">9,923--</tspan>)
</text>
